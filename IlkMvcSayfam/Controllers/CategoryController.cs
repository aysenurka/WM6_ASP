...
namespace IlkMvcSayfam.Controllers
{
    public class CategoryController:Controller
    {
        ...
        public ActionResult Update(int? id) {
            if (id == null)
                return RedirectToAction("Index","Category"); // boş bırakırsam bulunduğu indexe gider home veya cat verebilirim
            try
            {
                var data = new NorthwindSabahEntities().Categories.Find(id.Value);
                if (data == null)
            ...
            {
                return RedirectToAction("Index", "Category"); // sayfaya yönlendiriyorum
            }
        }
